                    ...
                    public void applyOptions(OkHttpClient.Builder builder) {
                        ...
                        builder.addInterceptor(new Interceptor() {
                            ...
                            public Response intercept(@NotNull Interceptor.Chain chain) throws IOException {
                                ...
                                Log.d("TokenInterceptor", "intercept:网络请求添加Token---Authorization----> " + SpsUtil.getString("access_token",""));
                                Log.d("TokenInterceptor", "intercept:网络请求添加Token---AreaToken----> " + SpsUtil.getString( Constants.AreaToken, ""));
                                requestBuilder.addHeader("Authorization", SpsUtil.getString("access_token","")!=null?SpsUtil.getString("access_token",""):"")
                                        .header("AreaToken",SpsUtil.getString( Constants.AreaToken, ""))
                                        .build();
                                Log.d("DEBUG", "-------------------");
