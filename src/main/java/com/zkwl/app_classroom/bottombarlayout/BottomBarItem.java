package com.zkwl.app_classroom.bottombarlayout;
...
public class BottomBarItem extends LinearLayout {
    ...
    private void checkValues() {
        ...
        if (unreadTextBg == null) {
            unreadTextBg = getResources().getDrawable(R.drawable.bbl_shape_unread);
        }

        if (msgTextBg == null) {
            msgTextBg = getResources().getDrawable(R.drawable.bbl_shape_msg);
        }

        if (notifyPointBg == null) {
            notifyPointBg = getResources().getDrawable(R.drawable.bbl_shape_notify_point);
        }
    }
    ...
    private View initView() {
        View view = View.inflate(context, R.layout.bbl_item_bottom_bar, null);
        if (itemPadding != 0) {
            //如果有设置item的padding
