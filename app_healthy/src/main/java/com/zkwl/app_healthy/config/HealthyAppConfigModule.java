package com.zkwl.app_healthy.config;
...
import com.zkwl.app_healthy.BuildConfig;
 ...
 */
public class HealthyAppConfigModule extends FrameConfigModule {
    @Override
    public void applyOptions(Context context, ConfigModule.Builder builder) {
         ...
         */
        //通过第一种方式初始化BaseUrl
        builder.baseUrl(HealthyConstants.BASE_URL);//TODO 配置Retrofit中的baseUrl
